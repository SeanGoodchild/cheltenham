...
const HERO_STAT_CONFIG = [
  ...
  { key: "totalReturns", label: "Total Returns", icon: CircleDollarSign, format: "currency" },
              ...
              return (
                ...
                >
                  <div className="flex items-center gap-2">
                    ...
                    <span className="text-[11px] uppercase tracking-wide text-muted-foreground">{config.label}</span>
                  </div>
                  <div className="mt-2.5 text-xl font-bold tracking-tight tabular-nums md:text-[1.65rem]">
